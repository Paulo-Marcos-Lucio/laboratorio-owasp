...
/**
 * A01:2025 Broken Access Control — Path Traversal (CWE-22).
 *
 * <p>{@link #lerVulneravel} resolve o nome de arquivo recebido direto sobre o diretório-base: um
 * nome como {@code ../../etc/passwd} escapa do diretório e lê arquivos arbitrários. {@link
 * #lerCorrigido} normaliza o caminho e recusa qualquer resultado que não permaneça dentro do
 * diretório permitido.
 */
